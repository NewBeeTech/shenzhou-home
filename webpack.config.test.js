...
module.exports = {
  entry: {
    ...
    vendor: ["react", "react-dom", "babel-polyfill", "whatwg-fetch", "promise-polyfill"],
  },
  // 这里应用程序开始执行
  // webpack 开始打包
  ...
  output: {
    ...
    // 「入口分块(entry -)」的文件名模板（出口分块？）

    publicPath: `https://qufenqipublicrw.oss-cn-hangzhou.aliyuncs.com/fe/${APPENV}/`, // string
